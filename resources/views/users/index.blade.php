                ...
                <div class="p-0 " style="width:100%;overflow-x:auto;">
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
                        <div class="md:mt-0 sm:flex sm:space-x-4 w-full">
                            <!-- Form untuk entries -->
                            <x-show-entries :route="route('users.index')" :search="request()->search">
                            </x-show-entries>
                        </div>

                        <div class="sm:ml-16 sm:mt-0 sm:flex sm:space-x-4 sm:flex-none">
                            <form action="{{ route('users.index') }}" method="GET" class="flex items-center flex-1">
                                    ...
                                    <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            <form action="{{ route('users.destroy', $user->id) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button
                                                    type="submit"class="mt-5 lg:mt-0 border-2 border-dashed border-red-500 text-red-500 hover:bg-red-100 px-3 py-1 rounded-xl h-10 w-10 text-xs"><i
                            ...
                            <div class="flex items-center justify-between">
                                <nav class="flex justify-start">
                                    <div class="text-sm flex gap-1">
                                        ...
                                        <div>to</div>
                                        <div class="font-bold">{{ count($users) }}</div>
                                        <div>of</div>
                                        <div class="font-bold">{{ count($users) }}</div>
                                        <div>entries</div>
                                    </div>
